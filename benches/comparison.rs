...
#[bench]
fn new_bit_vec(b: &mut Bencher) {
    b.iter(|| BitVec::<u32>::new_fill(false, NBITS as u64))
}

#[bench]
fn to_bit_vec(b: &mut Bencher) {
    b.iter(|| BitVec::from_bits(&[0u32; NBITS / 32] as &[u32]))
}
...
//
//#[bench]
//fn vec_u32_blockwise(b: &mut Bencher) {
//    fn or_vec_u32(v1: &[u32], v2: &[u32]) -> Vec<u32> {
//        let block_len = cmp::min(v1.len(), v2.len());
//        let mut result = vec![0; block_len];
//
//        for i in 0 .. block_len {
//            result.set_block(i, v1.get_block(i) | v2.get_block(i));
//        }
//
//        result
//    }
...
//
//#[bench]
//fn vec_u32_blockwise_fused(b: &mut Bencher) {
//    fn or_vec_u32_3(v1: &[u32], v2: &[u32], v3: &[u32]) -> Vec<u32> {
//        let block_len = cmp::min(v1.len(), cmp::min(v2.len(), v3.len()));
//        let mut result = vec![0; block_len];
//
//        for i in 0 .. block_len {
//            result.set_block(i, v1.get_block(i) | v2.get_block(i) | v3.get_block(i));
//        }
//
//        result
//    }
